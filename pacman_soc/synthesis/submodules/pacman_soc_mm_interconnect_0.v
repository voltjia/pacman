...
module pacman_soc_mm_interconnect_0 (
	...
	wire   [12:0] rsp_mux_src_channel;                                                                   // rsp_mux:src_channel -> nios2_processor_data_master_agent:rp_channel
	...
	wire   [12:0] rsp_mux_001_src_channel;                                                               // rsp_mux_001:src_channel -> nios2_processor_instruction_master_agent:rp_channel
	...
	wire   [12:0] cmd_mux_002_src_channel;                                                               // cmd_mux_002:src_channel -> nios2_processor_debug_mem_slave_agent:cp_channel
	...
	wire          cmd_mux_010_src_valid;                                                                 // cmd_mux_010:src_valid -> control_s1_agent:cp_valid
	wire  [105:0] cmd_mux_010_src_data;                                                                  // cmd_mux_010:src_data -> control_s1_agent:cp_data
	wire          cmd_mux_010_src_ready;                                                                 // control_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire   [12:0] cmd_mux_010_src_channel;                                                               // cmd_mux_010:src_channel -> control_s1_agent:cp_channel
	wire          cmd_mux_010_src_startofpacket;                                                         // cmd_mux_010:src_startofpacket -> control_s1_agent:cp_startofpacket
	wire          cmd_mux_010_src_endofpacket;                                                           // cmd_mux_010:src_endofpacket -> control_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_011_src_valid;                                                                 // cmd_mux_011:src_valid -> onchip_memory_s1_agent:cp_valid
	wire  [105:0] cmd_mux_011_src_data;                                                                  // cmd_mux_011:src_data -> onchip_memory_s1_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                                 // onchip_memory_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [12:0] cmd_mux_011_src_channel;                                                               // cmd_mux_011:src_channel -> onchip_memory_s1_agent:cp_channel
	wire          cmd_mux_011_src_startofpacket;                                                         // cmd_mux_011:src_startofpacket -> onchip_memory_s1_agent:cp_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                                           // cmd_mux_011:src_endofpacket -> onchip_memory_s1_agent:cp_endofpacket
	...
	wire  [105:0] cmd_mux_012_src_data;                                                                  // cmd_mux_012:src_data -> spi_spi_control_port_agent:cp_data
	...
	wire          control_s1_agent_rp_valid;                                                             // control_s1_agent:rp_valid -> router_012:sink_valid
	wire  [105:0] control_s1_agent_rp_data;                                                              // control_s1_agent:rp_data -> router_012:sink_data
	wire          control_s1_agent_rp_ready;                                                             // router_012:sink_ready -> control_s1_agent:rp_ready
	wire          control_s1_agent_rp_startofpacket;                                                     // control_s1_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire          control_s1_agent_rp_endofpacket;                                                       // control_s1_agent:rp_endofpacket -> router_012:sink_endofpacket
	...
	wire  [105:0] onchip_memory_s1_agent_rp_data;                                                        // onchip_memory_s1_agent:rp_data -> router_013:sink_data
	...
	wire  [105:0] spi_spi_control_port_agent_rp_data;                                                    // spi_spi_control_port_agent:rp_data -> router_014:sink_data
	...
	wire          control_s1_agent_rdata_fifo_src_valid;                                                 // control_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_010:in_0_valid
	wire   [33:0] control_s1_agent_rdata_fifo_src_data;                                                  // control_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_010:in_0_data
	wire          control_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_010:in_0_ready -> control_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_010_out_0_valid;                                                     // avalon_st_adapter_010:out_0_valid -> control_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_010_out_0_data;                                                      // avalon_st_adapter_010:out_0_data -> control_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_010_out_0_ready;                                                     // control_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_010:out_0_ready
	wire    [0:0] avalon_st_adapter_010_out_0_error;                                                     // avalon_st_adapter_010:out_0_error -> control_s1_agent:rdata_fifo_sink_error
